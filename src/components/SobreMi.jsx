  ...
  return (
    <div>
      ...
      <div className="fs-sobremi__datos">
        <div className="fs-sobremi__cuadro">
          <h3 className="fs-sobremi__cuadro__title">Sobre mí</h3>
          <ul className="fs-sobremi__datos_list">
            ...
            <li>
              Sobre mi: Me gusta mostrar a las personas lo que va más alla de
              una "simple" fotografía y hacerles ver lo que ellos a simple vista
              no pueden. Además, me gusta darle vida y diseñar
              portadas,revistas,etc.
            </li>
          </ul>
        </div>
      ...
      <div className="fs-sobremi__skills">
        ...
        <div className="fs-sobremi__skills_list">
          <div className="fs-sobremi__cuadro">
            <h3 className="fs-sobremi__cuadro__title">Habilidades</h3>
            <ul>
